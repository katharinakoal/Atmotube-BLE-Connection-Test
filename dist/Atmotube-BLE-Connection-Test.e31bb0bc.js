...
function () {
  ...
  _createClass(App, [{
    ...
    value: function init() {
      ...
      document.querySelector('button#init').addEventListener('pointerup', function (event) {
      ...
      document.querySelector('button#refresh').addEventListener('click', function (event) {
        _this.characteristic.readValue().then(console.log);
      });
    }
  }]);
...
//# sourceMappingURL=/Atmotube-BLE-Connection-Test.e31bb0bc.map